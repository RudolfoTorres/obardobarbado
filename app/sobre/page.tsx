                    ...
                    <section className="mb-24">
                        ...
                        <div className="grid md:grid-cols-2 gap-12 items-start mb-16">
                            <div className="space-y-6 font-sans text-ink/80 text-lg leading-relaxed">
                                ...
                                <p>
                                    Nascido nas Montanhas de Ferro, mas criado nas tavernas da metrópole de Nova Arthemis, Glockenspiel encontrou sua vocação: documentar o absurdo. Ele canta sobre espelhos que dão tela azul, sobre dragões que cobram taxa de entrega e sobre como é difícil encontrar uma "Conexão Arcana" (Con-Arc®) estável dentro de uma masmorra.
                                </p>
